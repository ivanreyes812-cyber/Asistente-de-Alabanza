...
def s(num, title, category, key, bpm, author, lyrics):
    songs.append({
        "id": f"manantial-{num}",
        "number": num,
        "title": title,
...
# 1 - 20
s(1, "Por Fe", "Doctrina", "C", 90, "Juan Carlos Pérez", """I
...
s(2, "Quiero Adorarte", "Adoración", "D", 72, "Juan Carlos Pérez", """[D]Digno de Honra, [A]digno de Gloria [Bm]y de adoración
...
s(3, "Sin Tu Amor", "Adoración", "Em", 68, "Guillermo Cabezas / Orlando Roa", """I
...
s(4, "Hay Poder en el Nombre", "Alabanza", "G", 110, "Juan Carlos Pérez", """I
...
s(5, "Quiero Llegar", "Adoración", "C", 75, "Edgar Devia", """I
...
s(6, "Nuevo Amanecer", "Alabanza", "D", 100, "Guillermo Cabezas / Orlando Roa", """I
...
s(7, "Tu Nombre", "Adoración", "G", 72, "Jhon Carlos Mena / Orlando Roa", """I
...
s(8, "Mensaje de Amor", "Evangelismo", "G", 88, "Edgar Devia", """I
...
s(9, "Gracias por Todo Jesús", "Agradecimiento", "D", 80, "Luz E. Cifuentes", """I
...
s(10, "Caña Cascada", "Consolación", "Em", 72, "Luz E. Cifuentes", """I
...
print(f"Total songs so far: {len(songs)}")
